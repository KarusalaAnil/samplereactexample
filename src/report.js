...
const ReceiptGenerator = () => {
    const generatePDF = () => {
        ...
        // const imageUrl = 'https://orchidfertility.in/wp-content/uploads/2024/04/new-orchid-logo.png';  // URL to your image or a base64 string
        const imageUrl = 'logo192.png';  // URL to your image or a base64 string
        const imgWidth = 30;  // Adjust the width as necessary
        const imgHeight = 20;  // Adjust the height as necessary
        const imgX = 25 - imgWidth / 2;  // Centering the image horizontally
        const imgY = 15;  // Adjust the vertical position
        // public/logo192.png
        // Add image to header (use base64 or URL)
        ...
        doc.text('Orchid Fertility Center', 105, imgY, { align: 'center' });
